    ...
    CONTENT_SECURITY_POLICY_DIRECTIVES.update(
        {
            'script-src': [
                ...
                #
                #
                "'sha256-e1KfyIE4F9fqROaWMTTPuxMQmIDcdBIMtpsZm3Qjkx4='",  # inline in /static/manager/
            ],
            'style-src': [
                SELF,
                ...
                #
                #
                "'sha256-PEa0r4RjqBTR1RmEDAxTQe3le3ODXojksrbuSVdaAls='",  # inline in /static/manager/
            ],
